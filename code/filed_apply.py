...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_data_path",default = r"../data/filed_apply",type = str,help = "path of test low seismic images with noise")
    ...
    parser.add_argument("--model_path",default = r"../result/MSRD-GAN/filed_apply",type = str,help = "pre_trained model use for test")
