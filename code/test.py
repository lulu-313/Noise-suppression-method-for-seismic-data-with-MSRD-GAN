...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_data_path",default = r"../data/test/1",type = str,help = "path of test low seismic images with noise")
    parser.add_argument("--test_target_path",default = r"../data/test/2",type = str,help = "path of test high seismic images without noise")
    parser.add_argument("--model_path",default = r"../result/MSRD-GAN/model/netG_bestmodel.pth",type = str,help = "pre_trained model use for test")
    parser.add_argument("--save_path",default = r"../result/MSRD-GAN",type = str,help = "save the test result")
